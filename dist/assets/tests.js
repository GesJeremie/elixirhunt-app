...
define('elixirhunt/tests/components/admin/jobs/form-component.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/admin/jobs/form-component.js should pass jshint.\ncomponents/admin/jobs/form-component.js: line 1, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncomponents/admin/jobs/form-component.js: line 2, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncomponents/admin/jobs/form-component.js: line 3, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncomponents/admin/jobs/form-component.js: line 5, col 1, \'const\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncomponents/admin/jobs/form-component.js: line 12, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\ncomponents/admin/jobs/form-component.js: line 18, col 3, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncomponents/admin/jobs/form-component.js: line 25, col 5, \'const\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncomponents/admin/jobs/form-component.js: line 34, col 5, \'const\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncomponents/admin/jobs/form-component.js: line 43, col 5, \'const\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncomponents/admin/jobs/form-component.js: line 52, col 5, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncomponents/admin/jobs/form-component.js: line 56, col 5, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncomponents/admin/jobs/form-component.js: line 66, col 14, \'arrow function syntax (=>)\' is only available in ES6 (use \'esversion: 6\').\ncomponents/admin/jobs/form-component.js: line 82, col 15, \'arrow function syntax (=>)\' is only available in ES6 (use \'esversion: 6\').\n\n13 errors');
  });
});
...
define('elixirhunt/tests/controllers/admin/jobs/index.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/admin/jobs/index.js should pass jshint.\ncontrollers/admin/jobs/index.js: line 2, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/admin/jobs/index.js: line 3, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/admin/jobs/index.js: line 5, col 1, \'const\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncontrollers/admin/jobs/index.js: line 9, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/admin/jobs/index.js: line 15, col 5, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncontrollers/admin/jobs/index.js: line 19, col 5, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncontrollers/admin/jobs/index.js: line 27, col 11, \'arrow function syntax (=>)\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/admin/jobs/index.js: line 29, col 18, \'arrow function syntax (=>)\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/admin/jobs/index.js: line 33, col 19, \'arrow function syntax (=>)\' is only available in ES6 (use \'esversion: 6\').\n\n9 errors');
  });
});
...
define('elixirhunt/tests/routes/admin/jobs/edit.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/admin/jobs/edit.js should pass jshint.\nroutes/admin/jobs/edit.js: line 1, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\nroutes/admin/jobs/edit.js: line 2, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\nroutes/admin/jobs/edit.js: line 4, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\nroutes/admin/jobs/edit.js: line 5, col 3, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\n\n4 errors');
  });
});
